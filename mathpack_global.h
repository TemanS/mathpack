...
#ifndef MATHPACK_GLOBAL_H
#define MATHPACK_GLOBAL_H

#include <QtCore/qglobal.h>

#if defined(MATHPACK_LIBRARY)
#  define MATHPACKSHARED_EXPORT Q_DECL_EXPORT
#else
#  define MATHPACKSHARED_EXPORT Q_DECL_IMPORT
#endif

#endif // MATHPACK_GLOBAL_H
